    ...
    o = (e, t) => {
      if (t && 11 == t.nodeType) e.e.parentNode.replaceChild(t, e.e);
        ...
        for (let e = j = 0; e < n.length && j < t.length;) {
          const o = n[e].r;
          o ? o == t[j].r ? (e++, j++) : t.some(e => e.r == o) ? r.insertBefore(t[j++], r.childNodes[e++]) : r.removeChild(r.childNodes[e]) : e++
        }
  ...
  window.StaticJS = (() => {
    ...
    return (l, ..._) => {
      if (!s) {
          ...
          o.replace(t, (t, _) => {
            ...
            if (f) {
              ...
              const f = document.createElement(_),
                m = c[s - 1];
              !i && d && "<" !== d && n(o, a, f, l), m && m.append(f), c[s] = f
            }
            f && !i || (s--, "<" !== d && d && n(o, a, c[s], l))
          });
        ...
        return f.firstChild.r = f.r = Date.now() + Math.random(), s = a, c = _, f
      }
